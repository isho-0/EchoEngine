namespace EchoEngine
{
   partial class AzureForm
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.groupBoxSTT.Text = "STT (Azure Speech Services)";
         // 
         // comboSTTLang
         // 
         ...
         this.checkBoxInterim.Location = new System.Drawing.Point(460, 32);
         this.checkBoxInterim.Name = "checkBoxInterim";
         this.checkBoxInterim.Size = new System.Drawing.Size(88, 16);
         this.checkBoxInterim.TabIndex = 1;
         this.checkBoxInterim.Text = "중간 결과 표시";
         ...
         this.groupBoxTTS.Text = "TTS (Azure Speech Services)";
         // 
         // labelVolume
         // 
         ...
         this.comboVoice.Size = new System.Drawing.Size(400, 20);
         ...
         this.Text = "Azure Speech Services STT/TTS";
